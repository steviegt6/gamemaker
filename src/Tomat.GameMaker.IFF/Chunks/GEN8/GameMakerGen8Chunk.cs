...
public sealed class GameMakerGen8Chunk : AbstractChunk {
    ...
    public override void Read(DeserializationContext context) {
        ...
        FileName = context.Reader.ReadPointer<GameMakerString>(context.Reader.ReadInt32());
        FileName.ReadObject(context, returnAfter: true);
        Config = context.Reader.ReadPointer<GameMakerString>(context.Reader.ReadInt32());
        Config.ReadObject(context, returnAfter: true);
        ...
        GameName = context.Reader.ReadPointer<GameMakerString>(context.Reader.ReadInt32());
        GameName.ReadObject(context, returnAfter: true);
        ...
        DisplayName = context.Reader.ReadPointer<GameMakerString>(context.Reader.ReadInt32());
        DisplayName.ReadObject(context, returnAfter: true);
