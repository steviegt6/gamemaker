...
public sealed class GameMakerGen8Chunk : AbstractChunk {
    ...
    public override void Read(DeserializationContext context) {
        ...
        GameName = context.Reader.ReadStringPointerObject(context, returnAfter: true);
        ...
        DisplayName = context.Reader.ReadStringPointerObject(context, returnAfter: true);
    ...
    public override void Write(SerializationContext context) {
        ...
        context.Writer.WritePointer(FileName);
        context.Writer.WritePointer(Config);
        ...
        context.Writer.WritePointer(GameName);
        ...
        context.Writer.WritePointer(DisplayName);
