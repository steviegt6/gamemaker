...
using Tomat.GameMaker.IFF.Chunks.PSEM;
using Tomat.GameMaker.IFF.Chunks.PSPS;
using Tomat.GameMaker.IFF.Chunks.PSYS;
...
using Tomat.GameMaker.IFF.Chunks.STAT;
...
internal sealed class GameMakerFormChunk : IFormChunk {
    ...
    public GameMakerFormChunk(string name, int size, int startPosition) {
        ...
        ChunkFactories = new Dictionary<string, ChunkFactory> {
            ...
            { GameMakerDfncChunk.NAME, (c, s, p) => new GameMakerDfncChunk(c, s, p) },
            ...
            { GameMakerPsemChunk.NAME, (c, s, p) => new GameMakerPsemChunk(c, s, p) },
            { GameMakerPsysChunk.NAME, (c, s, p) => new GameMakerPsysChunk(c, s, p) },
            ...
            { GameMakerPspsChunk.NAME, (c, s, p) => new GameMakerPspsChunk(c, s, p) },
            { GameMakerStatChunk.NAME, (c, s, p) => new GameMakerStatChunk(c, s, p) },
        };
